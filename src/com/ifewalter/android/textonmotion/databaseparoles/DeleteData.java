...
public class DeleteData {
	...
	public void deleteMessage(Context context, String string) {
		setDB(context);
		db.delete(InitDatabase.TABLE_MESSAGES, "_id=" + string, null);
	}

	public void deleteLongShort(Context context, String string) {
		setDB(context);
		db.delete(InitDatabase.TABLE_SHORTHAND, "_id=" + string, null);
	}

	public void deleteAbstractViewItem(Context context, String sentMessageId) {
		setDB(context);
	...
	public void deleteThread(Context context, String receipient) {
		setDB(context);
