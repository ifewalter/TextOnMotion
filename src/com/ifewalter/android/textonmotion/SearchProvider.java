...
public class SearchProvider extends ContentProvider {
	...
	public static String AUTHORITY = "com.ifewalter.android.textonmotion.SearchProvider";
	public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY
			+ "/text_on_motion_database");

	// MIME types used for searching words or looking up a single definition
	public static final String RECEIPIENT_MIME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE
			+ "/vnd.ifewalter.android.searchabletom";
	public static final String MESSAGE_CONTENT_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE
			+ "/vnd.ifewalter.android.searchabletom";

	private SearchDatabaseHelper mDictionary;
	...
	private static UriMatcher buildUriMatcher() {
		...
		// to get definitions...
		matcher.addURI(AUTHORITY, "text_on_motion_database", SEARCH_WORDS);
		matcher.addURI(AUTHORITY, "text_on_motion_database/#", GET_WORD);
		// to get suggestions...
	...
	public boolean onCreate() {
		mDictionary = new SearchDatabaseHelper(getContext());
		return true;
	}
	...
	private Cursor getSuggestions(String query) {
		...
		String[] columns = new String[]{BaseColumns._ID,
				SearchDatabaseHelper.RECEIPIENT,
				SearchDatabaseHelper.KEY_DEFINITION,
				/*
	...
	private Cursor search(String query) {
		query = query.toLowerCase();
		String[] columns = new String[]{BaseColumns._ID,
				InitDatabase.RECIEPIENT, InitDatabase.MESSAGE_CONTENT};
	...
	private Cursor getWord(Uri uri) {
		...
		String[] columns = new String[]{InitDatabase.RECIEPIENT,
	...
	public String getType(Uri uri) {
		switch (sURIMatcher.match(uri)) {
			case SEARCH_WORDS :
				return RECEIPIENT_MIME_TYPE;
			case GET_WORD :
				return MESSAGE_CONTENT_MIME_TYPE;
			case SEARCH_SUGGEST :
