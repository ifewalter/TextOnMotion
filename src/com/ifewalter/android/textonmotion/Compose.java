...
public class Compose extends Activity {
	...
	// public static int RECEIPIENT_COUNT =
	private SharedPreferences receipientList;
	...
	private void addLocation() {
		...
		SharedPreferences setting = getSharedPreferences(
				UserLocation.SAVED_LOCATION_NAME, 0);
		shortenedUrl = setting.getString(UserLocation.SAVED_LOCATION_URL,
				"http://maps.google.com");
		float accuracyNotification = (setting.getFloat(
